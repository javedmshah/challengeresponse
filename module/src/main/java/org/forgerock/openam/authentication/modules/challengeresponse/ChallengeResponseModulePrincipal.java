 ...
 */
public class ChallengeResponseModulePrincipal implements Principal, Serializable {

    private static final long serialVersionUID = 1L;
	private String name;

    public ChallengeResponseModulePrincipal(String name) {
        if (name == null) {
    ...
    public String toString() {
        return new StringBuilder()
                .append(ChallengeResponseModulePrincipal.class.getName())
                .append(":")
                .append(name)
                .toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChallengeResponseModulePrincipal)) {
            return false;
        }
        ChallengeResponseModulePrincipal that = (ChallengeResponseModulePrincipal) o;
